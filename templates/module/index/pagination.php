<?php if ($show): ?>
<div class="d-flex">
	<nav aria-label="Page navigation" hx-boost="true" hx-indicator="#request-progress" hx-target="main" hx-select="main" hx-swap="outerHTML show:no-scroll" hx-sync="this:abort">
	...
	<nav id="per-page">
		<select class="page-link text-dark" name="per_page" hx-get="" hx-target="main" hx-select="main" hx-swap="outerHTML">
