<?php if ($show): ?>
<div class="d-flex">
	<nav aria-label="Page navigation" hx-boost="true" hx-indicator="#request-progress" hx-target="#table-pagination" hx-select="#table-pagination" hx-swap="outerHTML" hx-sync="this:abort">
