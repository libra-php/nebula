...
<section id="actions" class="mb-3">
	<?php if ($actions['show_create_action']) : ?>
		<button type="button" hx-get="/admin/<?= $module ?>/create" hx-swap="outerHTML" hx-select="#content" hx-target="#content" class="btn btn-success btn-sm">Create</button>
	<?php endif ?>
	<?php if ($actions['show_export_action']) : ?>
	<a type="button" href="?export_csv" class="btn btn-success btn-sm">Export</a>
	<?php endif ?>
</section>
